        ...
        for i, c in enumerate(qs, start=1):
            ws.append(
                [
                    ...
                    c.pays_naissance or "",
                    c.get_nationalite_code_display() if c.nationalite_code else "",
                    c.nir or "",
                    c.age or "",
                    c.email or "",
                    c.telephone or "",
                    ...
                    c.get_dernier_diplome_prepare_code_display() if c.dernier_diplome_prepare_code else "",
                    c.get_diplome_plus_eleve_obtenu_code_display() if c.diplome_plus_eleve_obtenu_code else "",
                    c.get_derniere_classe_code_display() if c.derniere_classe_code else "",
                    c.intitule_diplome_prepare or "",
                    c.get_situation_avant_contrat_code_display() if c.situation_avant_contrat_code else "",
                    c.get_regime_social_code_display() if c.regime_social_code else "",
