...
export default function PrepaTableIC({
  items,
  selectedIds,
  onSelectionChange,
  onEdit,
  ...
  const totalAdhesions = items.reduce((s, d) => s + (d.nb_adhesions ?? 0), 0);
      ...
      <Table stickyHeader size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell>📝 Adhésions</TableCell>

            <TableCell>📈 Taux présence</TableCell>
            <TableCell>💚 Taux adhésion</TableCell>
            ...
            return (
              ...
              >
                ...
                <TableCell>
                  <Chip
                    size="small"
                    color={d.inscrits > 0 ? "info" : "default"}
                    label={d.inscrits ?? 0}
                  />
                </TableCell>
                ...
                <TableCell>
                  <Chip
                    size="small"
                    color={d.presents > 0 ? "primary" : "default"}
                    label={d.presents ?? 0}
                  />
                </TableCell>
                ...
                <TableCell>
                  <Chip
                    size="small"
                    color={d.absents > 0 ? "warning" : "default"}
                    label={d.absents ?? 0}
                  />
                </TableCell>
          ...
          >
            ...
            <TableCell>
              <Typography fontWeight={700} color="success.main">
                {totalAdhesions.toLocaleString("fr-FR")}
              </Typography>
            </TableCell>
