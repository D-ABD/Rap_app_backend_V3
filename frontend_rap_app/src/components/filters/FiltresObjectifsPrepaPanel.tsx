...
import type { Choice, ObjectifPrepaFiltresValues } from "../../types/prepa";

type Props = {
  options: { annee?: Choice[]; centre?: Choice[]; departement?: Choice[] } | undefined;
  values: ObjectifPrepaFiltresValues;
  onChange: (next: ObjectifPrepaFiltresValues) => void;
  onRefresh?: () => void;
  onReset?: () => void;
};
...
function buildReset(values: ObjectifPrepaFiltresValues): ObjectifPrepaFiltresValues {
  return {
    ...values,
    search: "",
    centre: undefined,
...
/* 🧩 Composant principal */
/* ------------------------------------------------------------------ */
export default function FiltresObjectifsPrepaPanel({
  options,
  values,
  onChange,
  onRefresh,
